...
SPDLOG_INLINE int remove(const filename_t &filename)
...
SPDLOG_INLINE int rename(const filename_t &filename1, const filename_t &filename2)
...
conditional_static_cast<int> (::getpid());

#endif
}


SPDLOG_INLINE bool is_color_terminal()
...
SPDLOG_INLINE bool in_terminal(FILE * file)
SPDLOG_NOEXCEPT
{
